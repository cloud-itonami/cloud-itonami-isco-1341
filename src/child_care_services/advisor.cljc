(ns child-care-services.advisor
  "ServicesAdvisor — proposes a child-care-services-management operation
  (staff plan, safety inspection, clear a safety incident, approve a
  staff-ratio exception) for a registered facility. The advisor is
  ...
  and has no notion of facility provenance or child-safety risk;
  `child-care-services.governor` is the independent system that decides
  whether the proposal may proceed, per the itonami actor pattern.

  A proposal is a map:
    {:op :staff-plan|:inspect|:clear-safety-incident|:approve-staff-ratio-exception
...
(def ^:private system-prompt
  "You are a child-care-services-management advisor. Given a services
